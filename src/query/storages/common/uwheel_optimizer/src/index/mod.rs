...
/// use datafusion_uwheel::index::IndexBuilder;
/// use datafusion_uwheel::index::UWheelAggregate;
///
...
impl IndexBuilder {
    ...
    /// let builder =
    ///     IndexBuilder::with_col_and_aggregate("temperature", UWheelAggregate::Max).with_conf(conf);
    /// ```
