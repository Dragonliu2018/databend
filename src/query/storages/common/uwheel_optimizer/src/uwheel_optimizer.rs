...
use uwheel::aggregator::min_max::MinMaxState;
...
pub struct UWheelOptimizer {
    ...
    /// Record batches which UWheelOptimizer builds indexes on top of
    // record_batch_vec: Vec<RecordBatch>,
...
pub(crate) fn scalar_to_timestamp(scalar: &ScalarValue) -> Option<i64> {
    match scalar {
...
mod tests {
    ...
    use datafusion::logical_expr::test::function_stub::sum;
