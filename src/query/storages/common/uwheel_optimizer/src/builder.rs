...
use uwheel::HawConf;
use uwheel_optimizer::scalar_to_timestamp;
use uwheel_optimizer::UWheelOptimizer;

use crate::uwheel_optimizer;
...
/// use std::sync::Arc;
///
/// use datafusion::common::arrow::array::Date32Array;
/// use datafusion::common::arrow::array::Float32Array;
...
impl Builder {
    ...
    /// use datafusion_uwheel::builder::Builder;
    ///
    /// let builder = Builder::new("timestamp").with_min_max_wheels(vec!["temperature", "humidity"]);
    /// ```
